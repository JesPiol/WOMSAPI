...
namespace COCAAPI.CocaHandshake_ {
    ...
    public partial class CocaHandshake : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public void ExposeNAVPOCOCA(ref PostedPurchaseInvoiceXML xML, string pONo, int selectedCompany, string transType) {
            object[] results = this.Invoke("ExposeNAVPOCOCA", new object[] {
                        ...
                        selectedCompany,
                        transType});
            xML = ((PostedPurchaseInvoiceXML)(results[0]));
        }
        
        /// <remarks/>
        public void ExposeNAVPOCOCAAsync(PostedPurchaseInvoiceXML xML, string pONo, int selectedCompany, string transType) {
            this.ExposeNAVPOCOCAAsync(xML, pONo, selectedCompany, transType, null);
        }
        
        /// <remarks/>
        public void ExposeNAVPOCOCAAsync(PostedPurchaseInvoiceXML xML, string pONo, int selectedCompany, string transType, object userState) {
    ...
    public partial class PostedPurchaseInvoice {
        ...
        private string prepayDocumentNoField;
        ...
        /// <remarks/>
        public string PrepayDocumentNo {
            get {
                return this.prepayDocumentNoField;
            }
            set {
                this.prepayDocumentNoField = value;
            }
        }
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="urn:microsoft-dynamics-nav/xmlports/x50082")]
    public partial class PostedPurchaseInvoiceXML {
        
        private PostedPurchaseInvoice[] postedPurchaseInvoiceField;
        
        private string[] textField;
        
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("PostedPurchaseInvoice")]
        public PostedPurchaseInvoice[] PostedPurchaseInvoice {
            get {
                return this.postedPurchaseInvoiceField;
            }
            set {
                this.postedPurchaseInvoiceField = value;
            }
        }
    ...
    public partial class ExposeNAVPOCOCACompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public PostedPurchaseInvoiceXML xML {
            get {
                this.RaiseExceptionIfNecessary();
                return ((PostedPurchaseInvoiceXML)(this.results[0]));
            }
        }
    }
